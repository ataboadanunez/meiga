// definition of the G4AndesDetectorConstruction class
#ifndef G4AndesDetectorConstruction_h
...
class G4AndesDetectorConstruction : public G4VUserDetectorConstruction {
	
	public:
		G4AndesDetectorConstruction(Event& theEvent);
		virtual ~G4AndesDetectorConstruction();
