#ifndef G4AndesSimulator_h
#define G4AndesSimulator_h 1
...
class G4AndesSimulator 
{
  public:
  
    G4AndesSimulator();
    virtual ~G4AndesSimulator() {;}
    ...
    static G4AndesSimulator* fG4AndesSimulator;
  ...
  private:
    ...
    std::string fPhysicsName = "QGSP_BERT_HP";
  	...
  	friend class G4AndesDetectorConstructor;
  	friend class G4AndesPrimaryGenerator;
};
