// definiton of the G4AndesPhysicsList class

#ifndef G4AndesPhysicsList_h
#define G4AndesPhysicsList_h 1
...
class G4AndesPhysicsList: public G4VModularPhysicsList
{
  public:

	G4AndesPhysicsList(G4String);
	virtual ~G4AndesPhysicsList();
