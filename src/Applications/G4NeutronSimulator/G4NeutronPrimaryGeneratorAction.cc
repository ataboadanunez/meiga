...
G4NeutronPrimaryGeneratorAction::GeneratePrimaries(G4Event* event)
{
  ...
  std::cout << "[INFO] G4NeutronPrimaryGeneratorAction::GeneratePrimaries: Injection Position = (" << x0 / cm << ", " << y0 / cm << ", " << z0 / cm << ") cm " << std::endl;
  std::cout << "[INFO] G4NeutronPrimaryGeneratorAction::GeneratePrimaries: Particle energy = " << fKineticEnergy / MeV << " MeV" << std::endl;
