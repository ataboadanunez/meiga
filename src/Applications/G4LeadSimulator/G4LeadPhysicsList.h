// definiton of the G4LeadPhysicsList class

#ifndef G4LeadPhysicsList_h
#define G4LeadPhysicsList_h 1
...
class G4LeadPhysicsList: public G4VModularPhysicsList
{
  public:

	G4LeadPhysicsList(G4String);
	virtual ~G4LeadPhysicsList();
