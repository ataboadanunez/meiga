// implementation of the G4LeadPhysicsList class
...
G4LeadPhysicsList::G4LeadPhysicsList(G4String physName) : G4VModularPhysicsList()
{
...
G4LeadPhysicsList::~G4LeadPhysicsList()
{
		//delete fMessenger;
...
void 
G4LeadPhysicsList::ClearPhysics()
{
...
void 
G4LeadPhysicsList::ConstructParticle()
{
...
void 
G4LeadPhysicsList::ConstructProcess()
{
...
void 
G4LeadPhysicsList::RemoveFromPhysicsList(const G4String& name)
{
...
void 
G4LeadPhysicsList::SetAbsorption(G4bool toggle)
{
...
void 
G4LeadPhysicsList::SetCutForGamma(G4double cut)
{
	fCutForGamma = cut;
...
void 
G4LeadPhysicsList::SetCutForElectron(G4double cut)
{
	fCutForElectron = cut;
...
void 
G4LeadPhysicsList::SetCutForPositron(G4double cut)
{
	fCutForPositron = cut;
...
void 
G4LeadPhysicsList::SetStepMax(G4double step)
{
	fStepMaxProcess->SetStepMax(step);
}

StepMax* 
G4LeadPhysicsList::GetStepMaxProcess()
{
	return fStepMaxProcess;
}

void 
G4LeadPhysicsList::AddStepMax()
{
...
void 
G4LeadPhysicsList::SetNbOfPhotonsCerenkov(G4int maxNumber)
{
...
void 
G4LeadPhysicsList::SetVerbose(G4int verbose)
{
