// definition of the G4RICHConstruction class
#ifndef G4RICHConstruction_h
#define G4RICHConstruction_h 1
...
class G4RICHConstruction : public G4VUserDetectorConstruction {
	
	public:
		G4RICHConstruction(Event& theEvent);
		virtual ~G4RICHConstruction();
