#ifndef G4RockFiberAction_h 
#define G4RockFiberAction_h 1
...
class G4RockFiberAction : public G4VSensitiveDetector {
  public:
    G4RockFiberAction(const G4String& name, Event& theEvent);
    virtual ~G4RockFiberAction() { }
