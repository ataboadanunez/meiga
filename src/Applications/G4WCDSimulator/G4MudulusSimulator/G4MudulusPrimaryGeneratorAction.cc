// implementation of the G4MudulusPrimaryGeneratorAction class
...
G4MudulusPrimaryGeneratorAction::G4MudulusPrimaryGeneratorAction(/*Event& theEvent, const Particle &theParticle*/) : 
  G4VUserPrimaryGeneratorAction(),
  fParticleGun(new G4ParticleGun(1))
  
{  

	fDetectorConstructor = static_cast<const G4MudulusDetectorConstruction*> (G4RunManager::GetRunManager()->GetUserDetectorConstruction());
  

}

G4MudulusPrimaryGeneratorAction::~G4MudulusPrimaryGeneratorAction()
{
  delete fParticleGun;
}
...
void 
G4MudulusPrimaryGeneratorAction::GeneratePrimaries(G4Event* event)
{
  ...
  if (!particleDef) {
      cout << "[WARNING] G4MudulusPrimaryGeneratorAction::GeneratePrimaries: Undefined particle with Corsika ID: " << currParticleID << endl;
      return;
    }
