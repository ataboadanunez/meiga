// implementation of the G4HodoscopePhysicsList class
...
G4HodoscopePhysicsList::G4HodoscopePhysicsList(G4String physName) : G4VModularPhysicsList()
{
...
G4HodoscopePhysicsList::~G4HodoscopePhysicsList()
{
		//delete fMessenger;
...
void 
G4HodoscopePhysicsList::ClearPhysics()
{
...
void 
G4HodoscopePhysicsList::ConstructParticle()
{
...
void 
G4HodoscopePhysicsList::ConstructProcess()
{
...
void 
G4HodoscopePhysicsList::RemoveFromPhysicsList(const G4String& name)
{
...
void 
G4HodoscopePhysicsList::SetAbsorption(G4bool toggle)
{
...
void 
G4HodoscopePhysicsList::SetCuts()
{
	if (verboseLevel >0) {
...
void 
G4HodoscopePhysicsList::SetCutForGamma(G4double cut)
{
	fCutForGamma = cut;
...
void 
G4HodoscopePhysicsList::SetCutForElectron(G4double cut)
{
	fCutForElectron = cut;
...
void 
G4HodoscopePhysicsList::SetCutForPositron(G4double cut)
{
	fCutForPositron = cut;
...
void 
G4HodoscopePhysicsList::SetStepMax(G4double step)
{
	fStepMaxProcess->SetStepMax(step);
}

StepMax* 
G4HodoscopePhysicsList::GetStepMaxProcess()
{
	return fStepMaxProcess;
}

void 
G4HodoscopePhysicsList::AddStepMax()
{
...
void 
G4HodoscopePhysicsList::SetNbOfPhotonsCerenkov(G4int maxNumber)
{
...
void 
G4HodoscopePhysicsList::SetVerbose(G4int verbose)
{
