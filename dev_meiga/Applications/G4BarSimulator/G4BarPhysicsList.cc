...
G4BarPhysicsList::G4BarPhysicsList(G4String physName) : G4VModularPhysicsList()
{
...
G4BarPhysicsList::~G4BarPhysicsList()
{
		//delete fMessenger;
...
void 
G4BarPhysicsList::ConstructParticle()
{
...
void 
G4BarPhysicsList::ConstructProcess()
{
...
void 
G4BarPhysicsList::RemoveFromPhysicsList(const G4String& name)
{
...
void 
G4BarPhysicsList::SetAbsorption(G4bool toggle)
{
...
void 
G4BarPhysicsList::SetCutForGamma(G4double cut)
{
	fCutForGamma = cut;
...
void 
G4BarPhysicsList::SetCutForElectron(G4double cut)
{
	fCutForElectron = cut;
...
void 
G4BarPhysicsList::SetCutForPositron(G4double cut)
{
	fCutForPositron = cut;
...
void 
G4BarPhysicsList::SetStepMax(G4double step)
{
	fStepMaxProcess->SetStepMax(step);
}

StepMax* 
G4BarPhysicsList::GetStepMaxProcess()
{
	return fStepMaxProcess;
}

void 
G4BarPhysicsList::AddStepMax()
{
...
void 
G4BarPhysicsList::SetNbOfPhotonsCerenkov(G4int maxNumber)
{
...
void 
G4BarPhysicsList::SetVerbose(G4int verbose)
{
