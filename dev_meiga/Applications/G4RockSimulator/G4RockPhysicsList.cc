// implementation of the G4RockPhysicsList class
...
void 
G4RockPhysicsList::ConstructParticle()
{
...
void 
G4RockPhysicsList::ConstructProcess()
{
...
void 
G4RockPhysicsList::RemoveFromPhysicsList(const G4String& name)
{
...
void 
G4RockPhysicsList::SetAbsorption(G4bool toggle)
{
...
void 
G4RockPhysicsList::SetCutForGamma(G4double cut)
{
	fCutForGamma = cut;
...
void 
G4RockPhysicsList::SetCutForElectron(G4double cut)
{
	fCutForElectron = cut;
...
void 
G4RockPhysicsList::SetCutForPositron(G4double cut)
{
	fCutForPositron = cut;
...
void 
G4RockPhysicsList::SetStepMax(G4double step)
{
	fStepMaxProcess->SetStepMax(step);
}

StepMax* 
G4RockPhysicsList::GetStepMaxProcess()
{
	return fStepMaxProcess;
}

void 
G4RockPhysicsList::AddStepMax()
{
...
void 
G4RockPhysicsList::SetNbOfPhotonsCerenkov(G4int maxNumber)
{
...
void 
G4RockPhysicsList::SetVerbose(G4int verbose)
{
