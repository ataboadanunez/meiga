#ifndef G4BarPhysicsList_h
#define G4BarPhysicsList_h 1
...
class G4BarPhysicsList: public G4VModularPhysicsList
{
  public:

	G4BarPhysicsList(G4String);
	virtual ~G4BarPhysicsList();
